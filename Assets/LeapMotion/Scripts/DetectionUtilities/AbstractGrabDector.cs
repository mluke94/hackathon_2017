...
namespace Leap.Unity { 
  ...
  *
  * Such detectors might use the PinchStrength, PinchStrength, GrabStrength, or GrabAngle
  * properties of the Hand or might use a more complex heuristic.
  */
  public abstract class AbstractGrabDetector : Detector {
    ...
    */
    ...
    protected float _lastStrength = 1.0f;
    ...
    public float LastActiveStrength { get { return _lastStrength; } }
    ...
    protected virtual void OnDrawGizmos () {
      if (ShowGizmos) {
        ...
        Utils.DrawCircle(centerPosition, Normal, Strength / 2, centerColor);
        Gizmos.color = NormalColor;
        Gizmos.DrawLine(centerPosition, centerPosition + Direction * Strength / 2);
        Gizmos.color = DirectionColor;
        Gizmos.DrawLine(centerPosition, centerPosition + Normal * Strength / 2);
      }
    }
    #endif
